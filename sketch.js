  ...
  if(particle!==null){
    particle.display();
      if(particle.y>600){
          ...
          if(particle.x>80 && particle.x<160){
            score=score+500;
            particle=null;
            if(turn===5){
              gameState="end";
      ...
      if(particle.x>160 && particle.x<240){
        score=score+100;
        particle=null;
        if(turn===5){
          gameState="end";
      ...
      if(particle.x>240 && particle.x<320){
        score=score+200;
        particle=null;
        if(turn===5){
          gameState="end";
...
if(particle.x>400 && particle.x<480){
  score=score+200;
  particle=null;
  if(turn===5){
    gameState="end";
